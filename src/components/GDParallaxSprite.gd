...
func _physics_process(delta: float) -> void:
	...
	if _camera != null:
		if _camera._delta_position.x > _camera_delta_threshold.x:
			position.x += _camera._delta_position.x * _parallax_factor.x
		if _camera._delta_position.y > _camera_delta_threshold.y:
		...
		if _phantomcamera_delta_position.x > _camera_delta_threshold.x:
			position.x += _phantomcamera_delta_position.x * _parallax_factor.x
		if _phantomcamera_delta_position.y > _camera_delta_threshold.y:
